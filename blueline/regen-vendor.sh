...
VENDOR_SKIP_FILES=(
    ...
    "etc/audio_platform_info_tavil_b1.xml"
    ...
    "etc/thermal-engine-blueline-novr-evt.conf"
    "etc/thermal-engine-blueline-novr-prod.conf"
    "etc/thermal-engine-blueline-vr-evt.conf"
    "etc/thermal-engine-blueline-vr-prod.conf"
    ...
    # or manually added as build targets in device-xdroid.mk
